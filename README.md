...
- lokale Schema-v26-Sync-Inbox mit atomarem Seiten-Ingest, exaktem Crash-Replay und einem begrenzten Scheduler, der bei ungelöstem Outbox-Konflikt unabhängige Root-Note-Updates/-Deletes über unveränderlich gebundene Einzelpläne anwendet, ohne den bestätigten Präfix zu überspringen; Strukturänderungen und vollständige Objektisolation bleiben für `SYNC-012` offen
