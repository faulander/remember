...
- lokale Schema-v25-Sync-Inbox als dauerhafte Grundlage für getrennten Download-/Apply-Fortschritt; sie ist noch nicht in `SyncOnce` verdrahtet und `SYNC-012` bleibt offen
