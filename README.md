...
- lokaler SQLite-Index, Reconcile, Watcher sowie sichtbare Update/Update-, bidirektionale Edit/Delete-, fehlende Remote-Objekt- und Note-Create/-Move-Pfadkonfliktkopien; bereits remote fehlende Deletes konvergieren ohne neue Kopie
...
- lokaler Index v10 mit crash-sicherer Outbox, exakter Blob-Staging-Ablage, Konflikt-/Rebase-/No-op-/Blob-Cleanup-Journalen, descriptor-gebundener Löschung technischer Bytes und resumierbarem Notiz-/Folder-Apply
