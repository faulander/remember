...
- automatisierter Zwei-Client-Konvergenztest über echte Login-, Blob- und Sync-HTTP-Routen einschließlich sichtbarer Update-Konfliktkopie sowie Folder-Create/-Move/-Delete
