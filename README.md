...
- lokaler Index v39 mit crash-sicherer Outbox, exakter Blob-Staging-Ablage, versiegelten rekursiven Recovery- und Preserve-delete-Manifesten, ancestry-gebundener Sync-Inbox, descriptor-gebundener Löschung technischer Bytes und resumierbarem Notiz-/Folder-Apply
...
- automatisierte Mehrgeräte-Konvergenz über echte Login-, Blob- und Sync-HTTP-Routen einschließlich rekursiver Folder-Create-Recovery, rekursivem Folder Delete gegen Remote-Move, tief verschachtelter Note-Isolation, A/B/Restart/Cold-C, Serverneustart, kaltem History-Bootstrap, Pagination, verlorenen Antworten und dauerhafter Pull-Seiten-Wiederaufnahme
