...
- lokaler Index v41 mit crash-sicherer Outbox, exakter Blob-Staging-Ablage, versiegelten rekursiven lokalen, gemischten serverbekannten und beidseitigen Parent-Ancestry-Recovery-Manifesten, ancestry-gebundener Sync-Inbox, descriptor-gebundener Löschung technischer Bytes und resumierbarem Notiz-/Folder-Apply
...
- automatisierte Mehrgeräte-Konvergenz über echte Login-, Blob- und Sync-HTTP-Routen einschließlich rekursiver Folder-Create-Recovery, rekursivem Folder Delete gegen Remote-Move, gemischter serverbekannter/lokaler Recovery divergenter Folder-Moves mit unterschiedlichen Parent-Zielen, tief verschachtelter Note-Isolation, A/B/Restart/Cold-C, Serverneustart, kaltem History-Bootstrap, Pagination, verlorenen Antworten und dauerhafter Pull-Seiten-Wiederaufnahme
