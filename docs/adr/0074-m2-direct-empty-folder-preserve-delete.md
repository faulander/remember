...
Die versionierte Preserve-and-delete-Anfrage v2 erweitert ADR 0070 ausschließlich um aktuell vorhandene direkte Child-Folder, die selbst leer sind. Notes, tiefere Folder und Änderungen nach dem vom Client bestätigten `known_cursor` werden abgelehnt. Der kanonische Root-Zustand muss ein Move sein; sein Change sowie die Historie des Roots und seiner direkten Children dürfen die bestätigte Grenze nicht überschreiten. Version, Grenze und Actor sind Bestandteil des unveränderlichen Replay-Hashes. V1 bleibt für historisch stets leere Folder kompatibel.
