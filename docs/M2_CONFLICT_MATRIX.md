...
1. Den engen Root-Note-Update/-Delete-Scheduler aus ADR 0057 auf weitere beweisbar unabhängige Objektformen erweitern und eine authentifizierte A/B-/Cold-C-Abnahme ergänzen; terminal abgebrochene Pläne benötigen zuvor eine explizite Retry-/Operator-Regel.
