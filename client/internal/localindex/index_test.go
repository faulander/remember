...
func TestV1UpgradePreservesSnapshotAndMarksBootstrap(t *testing.T) {
	...
	var version int
	if err := index.WithTransaction(ctx, func(tx *sql.Tx) error { return tx.QueryRow(`PRAGMA user_version`).Scan(&version) }); err != nil || version != 30 {
